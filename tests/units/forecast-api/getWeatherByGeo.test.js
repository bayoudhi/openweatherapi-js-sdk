const { getForecastByGeo } = require("../../../src/forecast-api/factories");
...
it('should reject "latitude is missing", when latitude is not passsed', async () => {
  ...
  await expect(getForecastByGeo({}, {})).rejects.toEqual(expectedResult);
});
it('should reject "longitude is missing", when longitude is not passsed', async () => {
  ...
  await expect(getForecastByGeo({}, { latitude: 37 })).rejects.toEqual(
    expectedResult
  );
});

describe("getForecastByGeo({axios,endpoint,apiKey},{latitude,longitude})", () => {
    ...
    describe('when endpoint equals "https://api.openweathermap.org/data/2.5/forecast"', () => {
      ...
      describe("when apiKey equals key007", () => {
        ...
        describe("when axios rejects", () => {
          ...
          describe("getForecastByGeo({axios,endpoint,apiKey},{latitude})", () => {
            let result;
            const expectedResult = axiosResponse;
            beforeEach(async () => {
              try {
                await getForecastByGeo(
...
describe("getForecastByGeo({axios,endpoint,apiKey},{latitude,longitude,lang})", () => {
  describe("when latitude equals 37 and longitude equals 10", () => {
    const latitude = 37;
    const longitude = 10;
    const lang = "fr";
...
describe("getForecastByGeo({axios,endpoint,apiKey},{latitude,longitude,lang,units})", () => {
  describe("when latitude equals 37 and longitude equals 10", () => {
    const latitude = 37;
    const longitude = 10;
    const lang = "fr";
...
describe("getForecastByGeo({axios,endpoint,apiKey},{latitude,longitude,units})", () => {
  describe("when latitude equals 37 and longitude equals 10", () => {
    const latitude = 37;
    const longitude = 10;
    const units = "metric";
