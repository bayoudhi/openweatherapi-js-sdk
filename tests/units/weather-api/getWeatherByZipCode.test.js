const { getWeatherByZipCode } = require("../../../src/weather-api/factories");

it('should reject "zipCode is missing", when zipCode is not passsed', async () => {
  const expectedResult = new Error("zipCode is missing");
  await expect(getWeatherByZipCode({}, {})).rejects.toEqual(expectedResult);
});

describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode})", () => {
      ...
      describe("when apiKey equals key007", () => {
        ...
        describe("when axios resolves", () => {
          ...
          describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode})", () => {
            ...
            beforeEach(async () => {
              try {
                result = await getWeatherByZipCode(
                  { axios, endpoint, apiKey },
                  { zipCode }
                );
              } catch (e) {}
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,lang})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const lang = "ar";
    describe('when endpoint equals "https://api.openweathermap.org/data/2.5/weather"', () => {
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,lang,units})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const lang = "ar";
    const units = "metric";
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,units})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const units = "metric";
    describe('when endpoint equals "https://api.openweathermap.org/data/2.5/weather"', () => {
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,countryCode})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,countryCode,lang})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const countryCode = "us";
    const lang = "ar";
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,countryCode,lang,units})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const countryCode = "us";
    const lang = "ar";
...
describe("getWeatherByZipCode({axios,endpoint,apiKey},{zipCode,countryCode,units})", () => {
  describe("when zipCode equals London", () => {
    const zipCode = 94040;
    const countryCode = "us";
    const units = "metric";
