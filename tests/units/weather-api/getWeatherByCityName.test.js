const { getWeatherByCityName } = require("../../../src/weather-api/factories");
...
it('should reject "cityName is missing", when cityName is not passsed', async () => {
  ...
  await expect(getWeatherByCityName({}, {})).rejects.toEqual(expectedResult);
  await expect(getWeatherByCityName({}, { cityName: "" })).rejects.toEqual(
    expectedResult
  );
});

describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName})", () => {
      ...
      describe("when apiKey equals key007", () => {
        ...
        describe("when axios resolves", () => {
          ...
          describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName})", () => {
            ...
            beforeEach(async () => {
              try {
                result = await getWeatherByCityName(
                  { axios, endpoint, apiKey },
                  { cityName }
                );
              } catch (e) {}
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,stateCode})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const stateCode = "uk";
    describe('when endpoint equals "https://api.openweathermap.org/data/2.5/weather"', () => {
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,stateCode,countryCode})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const stateCode = "uk";
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,lang})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const lang = "ar";
    describe('when endpoint equals "https://api.openweathermap.org/data/2.5/weather"', () => {
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,stateCode,lang})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const stateCode = "uk";
    const lang = "fr";
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,stateCode,countryCode,lang})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const stateCode = "uk";
    const countryCode = "GB";
...
describe("getWeatherByCityName({axios,endpoint,apiKey},{cityName,stateCode,countryCode,lang,units})", () => {
  describe("when cityName equals London", () => {
    const cityName = "London";
    const stateCode = "uk";
    const countryCode = "GB";
